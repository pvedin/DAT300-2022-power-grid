...
def test_modal_decomposition():
    ...
    net = PowerGrid(14)
    z = net.create_measurements(46, 1)
    cfg = {
        "Z": z,
        "T": 40,
        "t": 44,
    ...
    try:
        a = AnomalyModels.modal_decomposition(**cfg)
